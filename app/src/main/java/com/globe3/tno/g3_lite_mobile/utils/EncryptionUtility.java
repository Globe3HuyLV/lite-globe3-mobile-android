...
public class EncryptionUtility {
    ...
    private EncryptionUtility(Builder builder) {
        this.builder = builder;
    }

    public static EncryptionUtility getDefault(String key, String salt, byte[] iv) {
        try {
    ...
    public static class Builder {
        ...
        public EncryptionUtility build() throws NoSuchAlgorithmException {
            setSecureRandom(SecureRandom.getInstance(getSecureRandomAlgorithm()));
            setIvParameterSpec(new IvParameterSpec(getIv()));
            return new EncryptionUtility(this);
        }
